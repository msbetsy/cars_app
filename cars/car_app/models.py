...
class Car(models.Model):
    make = models.ForeignKey("Manufacturer", related_name='make', on_delete=models.CASCADE, null=False)
...
class Manufacturer(models.Model):
    manufacturer_name = models.CharField(max_length=250, null=False, default=None)
